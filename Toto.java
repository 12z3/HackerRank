...
public class Toto extends Methods {
    ...
    private static void generateTotoNum(List<Integer> last, int variants, int thisNumber) {
        ...
        while (counter < variants) {
            ...
            for (int k = 0; k < 6; k++) {
                ...
                switch (answer) {
                    case 'n' -> {
                        if (!listContainsEl(list, el) && el != 0) {               // Да не се съдържа в "last" и "List"
                    ...
                    case 'y' -> {
                        if (!listContainsEl(list, el) && !listContainsEl(last, el) && el != 0) {
                            list.add(el);
                        } else {
                            if (k != 0 && k > -1) {
                                k--;
    ...
    private static boolean listContainsEl(List<Integer> l1, int l2) {
